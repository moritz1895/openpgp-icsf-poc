...
class PgpPublicKeyAlgorithmTest {
    ...
    @ParameterizedTest
    @EnumSource(value = PgpPublicKeyAlgorithm.class, names = {"RSA", "X25519", "ML_KEM_768_X25519"})
    ...
    @ParameterizedTest
    @EnumSource(value = PgpPublicKeyAlgorithm.class, names = {"X25519", "ML_KEM_768_X25519"})
